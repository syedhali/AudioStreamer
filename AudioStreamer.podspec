#
#  Be sure to run `pod spec lint AudioStreamer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Syed Haris Ali" => "email@address.com" }
  # Or just: s.author    = "Syed Haris Ali"
  # s.authors            = { "Syed Haris Ali" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Syed Haris Ali"
